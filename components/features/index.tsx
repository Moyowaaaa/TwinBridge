...
const FeaturesSection = () => {
  return (
    <>
      <div className="w-full flex justify-center bg-[#fafafa] py-[3rem] md:py-[6.25rem]">
        <div className="w-full max-w-[85rem] px-[1.25rem] md:px-0 flex flex-col lg:flex-row gap-[1.5rem] lg:gap-[6.25rem]">
          <div className="w-full lg:w-1/3 flex flex-col items-start lg:pt-[1rem]">
          ...
          <div className="w-full lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-[1rem] md:gap-[1.5rem]">
            <div className="bg-white rounded-[1rem] md:rounded-[1.5rem] p-[1.5rem] md:p-[2.5rem] flex flex-col justify-between min-h-[260px] md:min-h-[340px]">
            ...
            <div className="bg-white rounded-[1rem] md:rounded-[1.5rem] p-[1.5rem] md:p-[2.5rem] flex flex-col justify-between min-h-[260px] md:min-h-[340px] sm:col-span-2">
              <div className="w-[2.5rem] h-[2.5rem] md:w-[3rem] md:h-[3rem] bg-[#eef2f6] rounded-[0.5rem] flex items-center justify-center">
                <Handshake
                  className="text-[#2a3e6f] w-[1.25rem] h-[1.25rem] md:w-[1.5rem] md:h-[1.5rem]"
                  strokeWidth={2}
              ...
              <div className="flex flex-col gap-[0.25rem] md:gap-[0.5rem] mt-[3rem] md:mt-[4rem]">
                ...
                <p className="text-[#7c7c7c] text-[0.875rem] md:text-[1rem] leading-[1.6]">
                  From document checklist to final submission, we are with you
                  at every bridge.
                </p>
              </div>
            </div>
