            ...
            <div className="w-full md:w-1/2 flex flex-col gap-[2.5rem] justify-center">
              {PATHWAYS.map((pathway, index) => (
                <div key={index} className="flex flex-col gap-[0.5rem]">
                  <span className="text-[0.875rem] text-[#8c8c8c] font-medium">
                    {pathway.number}
                  </span>
        ...
        <div className="w-full max-w-[85rem] px-[1.25rem] md:px-0 flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[1.5rem] w-full">
            {STEPS.map((step, index) => (
              <div
                key={index}
                className="bg-white rounded-[1rem] p-[2rem] flex flex-col justify-between min-h-[260px] md:min-h-[280px]"
              >
                <span className="text-[0.875rem] text-[#7c7c7c] font-medium">
                  {step.number}
                </span>
