      ...
      <div className="w-full flex justify-center bg-white py-[4rem] md:py-[5rem]">
        <div className="w-full max-w-[85rem] flex flex-col items-center px-[1.25rem] md:px-0 gap-[6.25rem]">
          <div className="flex flex-col w-full relative items-center">
            <div className="bg-[#f4f7f9] w-max rounded-[2rem] px-[1rem] py-[0.5rem] mb-[1.5rem] flex items-center justify-center">
            ...
            <div className="w-full mx-auto relative h-[300px] sm:h-[400px] md:h-[714px] rounded-[1.5rem]  overflow-hidden">
              <Image
          ...
          <div className="w-full flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-[1.5rem] w-full">
              {VISAS.map((visa, index) => (
                <div
                  key={index}
                  className="relative w-full h-[400px] md:h-[500px] rounded-[16px] overflow-hidden  flex items-end"
                >
                  <Image
                    src={visa.image}
                    alt={visa.title}
                  ...
                  />
                  <div className="absolute bottom-0 left-0 w-full h-[336px] bg-gradient-to-t from-[#000000] to-transparent z-10" />

                  <div className="relative z-20 w-full p-[1.5rem] md:p-[2rem] flex flex-col gap-[0.25rem]">
        ...
        <div className="w-full md:w-1/2 flex justify-end">
          <div className="w-full max-w-[42.5rem] px-[1.25rem] py-[4rem] md:py-[6rem] md:pr-[4rem] xl:pr-[6rem] flex flex-col justify-center">
            ...
            <div className="flex flex-col sm:flex-row gap-[2rem] mt-[3rem] max-w-[38rem]">
              <div className="flex gap-[1rem] items-start w-full sm:w-1/2">
                <div className="min-w-[1.5rem] h-[1.5rem] mt-[0.125rem] bg-[#2a3e6f] rounded-full flex items-center justify-center flex-shrink-0">
                  <Check
                    className="w-[1rem] h-[1rem] text-white"
                    strokeWidth={3}
                  />
                </div>
                <p className="text-[#111111] text-[0.875rem] font-medium leading-[1.6]">
